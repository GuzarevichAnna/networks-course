...
#### Демонстрация работы
Код находится в файле speed_measurement.py (вместе с реализацией для UDP), скриншот работы приложения - ниже.
...
#### Демонстрация работы
Код находится в файле speed_measurement.py (вместе с реализацией для TCP).  
...
#### Демонстрация работы
Код находится в файле port_forwarder.py, стартовая конфигурация транслятора - в файле port_forwarder_config.json.  
