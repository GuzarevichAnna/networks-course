...
##### Создание пользователя TestUser и указание директории для него:  
![alt text](image-5.png)  
  
##### Изначальное содержимое папки на сервере:  
![alt text](image-6.png)  
  
##### Содержимое папки на сервере после создания пользователем directory1 и file0.txt:  
![alt text](image-7.png)  
  
##### Содержимое папки на сервере после загрузки пользователем локального файла file1.txt на сервер:  
...
#### Демонстрация работы
Код консольного клиента на сокетах находится в файле ftp_console_client.py, демонстрация работы --- в файле ftp_console_client_demo.txt.
